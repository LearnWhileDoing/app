...
import { PageProgressDropdown } from "~/content/components/PageProgressDisplay";
...
export const ContentHeader: React.FC<{ children?: React.ReactNode } & ContentHeaderProps> = ({ title, desc }) => (
  <Stack
