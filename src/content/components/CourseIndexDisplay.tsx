...
> = ({ index }) => {
  ...
  return (
    <VStack ref={scrollRef} divider={<Divider />} align={"start"} w={"full"} h={"full"} overflow={"scroll"} spacing={0}>
          ...
          >
            ...
            <Box w={"full"}>
              {Object.entries(chapter.content).map(([pageId, page], j) => {
                ...
                return (
                  <NextLink key={j} href={`/course/${courseId}/${chapterId}/${pageId}`} passHref>
                    <HStack
                      as={"a"}
                    ...
                    >
                      <Box pos={"relative"} mr={2}>
                        <Box
                          ...
                          bg={
                            PageProgressColors[userData?.current[courseId]?.[chapterId]?.[pageId]]?.line ||
                      ...
                      <Box py={2}>
                        <Text
                          ...
                          color={
                            active
                              ? PageProgressColors[userData?.current[courseId]?.[chapterId]?.[pageId]]?.text ||
                                "blue.500"
                              : "gray.600"
                          }
                        >
