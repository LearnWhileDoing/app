...
import { PageProgressDisplay } from "~/content/components/PageProgressDisplay";
import { inlineCodeStyle } from "~/content/components/mdx";

export const PageContent: React.FC<{ children?: React.ReactNode } & CoursePage> = ({ name, description, children }) => (
  <>
